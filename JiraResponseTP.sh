...
query='{
    "query": "{ getTestPlans(jql: \"project = PX\", limit: 4 ) { results { issueId jira(fields: [\"key\", \"summary\", \"customfield_10037\", \"customfield_10106\",\"customfield_10107\",\"customfield_10108\" ]) } } }"
}'
